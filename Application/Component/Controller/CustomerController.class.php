...
class CustomerController extends BaseController{
    ...
    function getCompanyList($parameter=[],$one=false){
        ...
        $parameter["fields"]="`companyId`,`company`,`alias`,`provinceId`,`cityId`,`province`,`city`,`address`,`remarks`,`addTime`,`updateTime`,`status`,`user_id`,`examine`,process_level";
    ...
    function getCustomerList($parameter=[],$one=false){
        ...
        $parameter["fields"]="`contactId`,`companyId`,`contact`,`phone`,`email`,`address`,`remarks`,`addTime`,`updateTime`,`status`,company,`user_id`,`examine`,process_level";

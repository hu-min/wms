...
if (typeof window !== 'undefined' && window['pdfjs-dist/build/pdf']) {
  ...
  pdfjsLib = require(PDF_LIB_DIR+'/build/pdf.js');
}
...
function configure(PDFJS) {
  PDFJS.imageResourcesPath = PDF_LIB_DIR+'/web/images/';
  PDFJS.workerSrc = PDF_LIB_DIR+'/build/pdf.worker.js';
  PDFJS.cMapUrl = PDF_LIB_DIR+'/web/cmaps/';
...
// var DEFAULT_URL = 'http://inner.vwms.com/Uploads/Project/upload_filesAdd/20180723/suanfa.pdf';
;
